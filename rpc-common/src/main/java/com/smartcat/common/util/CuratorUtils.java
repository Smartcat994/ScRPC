...
public  final class CuratorUtils {
    ...
    static {
        try {
            PROPS.load(new FileInputStream("zookeeper.properties"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    private static final int BASE_SLEEP_TIME = Integer.parseInt(PROPS.getProperty("BASE_SLEEP_TIME"));
    private static final int MAX_RETRIES = Integer.parseInt(PROPS.getProperty("MAX_RETRIES"));
    public static final String ZK_REGISTER_ROOT_PATH = PROPS.getProperty("ZK_REGISTER_ROOT_PATH");
    private static final Map<String, List<String>> SERVICE_ADDRESS_MAP = new ConcurrentHashMap<>();
    private static final Set<String> REGISTERED_PATH_SET = ConcurrentHashMap.newKeySet();
    private static CuratorFramework zkClient;
    private static String defaultZookeeperAddress = PROPS.getProperty("defaultZookeeperAddress");
